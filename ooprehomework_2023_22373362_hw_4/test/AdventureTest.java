...
public class AdventureTest {
    ...
    public void testUsebottle() {
        ...
        assertEquals(530,x);
        assertEquals(0,y);
         Bottle bottle3 = new Bottle(12,"dqr",30);
        Adventure man3 = new Adventure(12,"dqr");
        man.addBottle(bottle3);
        man.usebottle(man3,"dqr");
    }
...
@Test
    ...
    public void testusebottle2() {
        ...
        Bottle bottle = new Bottle(111,"lb",50);
        man.addBottle(bottle);
        man.usebottle2(man,"lb");

        Bottle bottle1 = new Bottle(123,"lzj",40);
        bottle1.set(bottle1);
        man.addBottle(bottle1);
        man.usebottle2(man,"lzj");

        Bottle bottle2 = new Bottle(123,"gxp",0);
        bottle1.set(bottle2);
        man.addBottle(bottle2);
        man.usebottle2(man,"gxp");
    }
    ...
    public void testuseequ() {
        ...
        Equipment equipment = new Equipment(123,"ok",1);
        man.addEquipment(equipment);
        equipment.set(equipment);

        Equipment equipment1 = new Equipment(111,"alright",2);
